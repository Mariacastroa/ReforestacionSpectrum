...
st.markdown(
    ...
    <style>
        :root {
            ...
            --sp-text: #17332A;
            --sp-soft: #F4F8F5;
            --sp-border: rgba(18, 53, 42, 0.10);
            --sp-shadow: 0 18px 60px rgba(13, 52, 42, 0.10);
        }

        .stApp {
            background:
                radial-gradient(circle at top left, rgba(165, 214, 167, 0.28), transparent 30%),
                radial-gradient(circle at top right, rgba(23, 59, 87, 0.08), transparent 25%),
                linear-gradient(180deg, #EEF5F0 0%, #F7FAF8 38%, #F5F7F8 100%);
            color: var(--sp-text);
        }
        ...
        .eco-shell {
            ...
            overflow: hidden;
            border-radius: 24px;
            background: linear-gradient(110deg, rgba(243,248,244,0.92) 0%, rgba(236,245,239,0.90) 34%, rgba(170, 198, 104, 0.88) 100%);
            min-height: 380px;
            padding: 1rem;
            border: 1px solid rgba(255,255,255,0.55);
        }
        ...
        .eco-shell::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 75% 32%, rgba(255,255,255,0.55), transparent 20%),
                radial-gradient(circle at 82% 66%, rgba(46,139,87,0.24), transparent 18%),
                linear-gradient(90deg, rgba(255,255,255,0.32) 0%, rgba(255,255,255,0.12) 42%, rgba(11,93,59,0.08) 100%);
            pointer-events: none;
        }
        ...
        .eco-left h1 .highlight {
            color: rgba(11,93,59,0.98);
            display: block;
        }
        ...
        .eco-orb {
            ...
            border-radius: 50%;
            background:
                radial-gradient(circle at 30% 28%, rgba(255,255,255,0.88), rgba(255,255,255,0.08) 30%),
                linear-gradient(145deg, #79B55B 0%, #8BC34A 36%, #2E8B57 100%);
            box-shadow:
                inset -18px -16px 40px rgba(7, 56, 33, 0.26),
                0 24px 70px rgba(14, 74, 45, 0.20);
        ...
        .eco-orb::before {
            ...
            border-radius: 50%;
            background:
                radial-gradient(circle at 42% 42%, rgba(215, 239, 220, 0.95), rgba(177, 214, 152, 0.82) 28%, rgba(0,0,0,0) 30%),
                radial-gradient(circle at 65% 65%, rgba(255,255,255,0.12), transparent 26%),
                radial-gradient(circle at 50% 50%, rgba(0,0,0,0), rgba(0,0,0,0) 55%, rgba(255,255,255,0.30) 56%, rgba(255,255,255,0) 59%);
            opacity: .95;
        }
        ...
        .eco-float.one { top: 16%; left: 0%; }
        .eco-float.two { bottom: 8%; right: 3%; }
        ...
        .info-box {
            ...
            border: 1px solid rgba(23,59,87,0.10);
            border-left: 5px solid #173B57;
            border-radius: 18px;
            padding: .95rem 1rem;
            margin-bottom: .85rem;
            box-shadow: 0 10px 26px rgba(15, 45, 38, 0.06);
        ...
        .phase-card {
            ...
            border-radius: 18px;
            min-height: 90px;
            box-shadow: 0 14px 28px rgba(11, 93, 59, .16);
        }
        ...
        div[data-testid="stMetric"] {
            ...
            padding: 1rem 1rem;
            border-radius: 20px;
            box-shadow: 0 14px 34px rgba(13, 45, 36, 0.06);
            backdrop-filter: blur(8px);
        }

        div[data-testid="stMetric"] label,
        div[data-testid="stMetric"] [data-testid="stMetricLabel"] {
            color: rgba(23, 51, 42, 0.72) !important;
            font-weight: 600;
        }
        ...
        div[data-testid="stDataEditor"], div[data-testid="stDataFrame"] {
            ...
            border-radius: 18px;
            border: 1px solid var(--sp-border);
            box-shadow: 0 12px 28px rgba(15, 45, 38, 0.05);
            overflow: hidden;
        }
        ...
        button[data-baseweb="tab"] {
            ...
            border: 1px solid rgba(23,59,87,0.08) !important;
            padding: .45rem .95rem !important;
            color: #204034 !important;
        }

        button[data-baseweb="tab"][aria-selected="true"] {
            background: linear-gradient(90deg, #0B5D3B, #2E8B57) !important;
        ...
        .stDownloadButton > button {
            border-radius: 999px !important;
            border: 1px solid rgba(23,59,87,0.12) !important;
            padding: .58rem 1rem !important;
            font-weight: 600 !important;
            background: rgba(255,255,255,0.84) !important;
            color: #17332A !important;
            box-shadow: 0 10px 22px rgba(15, 45, 38, 0.06);
        }
        ...
        div[data-baseweb="input"] > div {
            ...
            border: 1px solid rgba(23,59,87,0.10) !important;
            background: rgba(255,255,255,0.82) !important;
            box-shadow: 0 10px 22px rgba(15,45,38,0.04);
        }
        ...
        div[data-testid="stForm"] {
            ...
            border: 1px solid rgba(255,255,255,0.62);
            padding: 1rem;
            box-shadow: 0 14px 36px rgba(13,45,36,0.06);
            backdrop-filter: blur(10px);
        }
        ...
        @media (max-width: 980px) {
            ...
            .eco-float.one { left: 4%; }
            .eco-float.two { right: 4%; }
        }
    </style>
    """,
...
estado_carga_mapa = st.empty()
estado_carga_mapa.info(
    "Preparando el mapa y cargando las zonas de Ciudad de Guatemala…"
)

GEOJSON_ZONAS, ZONE_LOOKUP, ERROR_ZONAS = cargar_zonas_ciudad_guatemala()
estado_carga_mapa.empty()
    ...
    <div class="spectrum-header">
        <div class="eco-shell">
            <div class="eco-nav">
                <div class="eco-brand">
                    SPECTRUM
                    <span>PLATAFORMA DE REFORESTACIÓN</span>
                </div>
            ...
            <div class="eco-hero">
                <div class="eco-left">
                    <div class="eco-badge">Gestión ambiental inteligente</div>
                    <h1>
                        Reforestación
                        <span class="highlight">sostenible y visual</span>
                    </h1>
                    <p>
                        Plataforma para registrar, visualizar y dar seguimiento a
                        proyectos de reforestación, inventario de viveros y árboles
                        removidos por construcción, con una estética inspirada en
                        interfaces editoriales verdes, limpias y modernas.
                    </p>
                    <div class="eco-pill-row">
                        <span class="eco-pill">Ciudad de Guatemala</span>
                        <span class="eco-pill">Synergy</span>
                        <span class="eco-pill">Mapa interactivo</span>
                        <span class="eco-pill">Indicadores acumulados</span>
                    </div>
                </div>
                <div class="eco-right">
                    <div class="eco-orb"></div>
                    <div class="eco-float one">
                        <small>Enfoque</small>
                        <strong>Reforestación + viveros</strong>
                    </div>
                    <div class="eco-float two">
...
st.divider()
st.markdown("<div class='section-chip'>Registro principal</div>", unsafe_allow_html=True)
...
# VIVEROS Y TALA
st.divider()
st.markdown("<div class='section-chip'>Inventario y control</div>", unsafe_allow_html=True)
...
st.divider()
st.markdown("<div class='section-chip'>Análisis y seguimiento</div>", unsafe_allow_html=True)
